...
public:
	 ...
	 * Aktivierung die Ausführung mit der Funktion kickoff beginnt, die 
	 ...
	 * im System. Daher müssen hier keine Registerwerte gerettet werden.
	 */
	void go ();
	...
	/**
	 * Mit dieser Methode wird ein Koroutinenwechsel ausgelöst. Die 
	 * aktuelle Belegung der nicht-flüchtigen Register wird in dem 
	 * toc Element gesichert und durch die Werte von next (dem toc 
	 * Element der nächsten Koroutine) ersetzt.
	 */
